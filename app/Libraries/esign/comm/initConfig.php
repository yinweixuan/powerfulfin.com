 ...
 *
 * */
return config('app.env') == 'local' ? array(
    //===============================
    //          测试环境
    //===============================
    /* 项目初始化请求地址 */
    ...
    /* 接入平台项目ID,必填； */
    'project_id' => env('ESIGN_ID_DEV'),
    /* 项目密钥，必填 */
    'project_secret' => env('ESIGN_SECRET_DEV'),
    /**
    ...
    'retry' => 3,
    /* 本地java服务 */
    'java_server' => env('ESIGN_SERVER_DEV')
        ) : array(
    //===============================
    //          正式环境
    //===============================
    ...
    /* 接入平台项目ID,必填； */
    'project_id' => env('ESIGN_ID'),
    /* 项目密钥，必填 */
    'project_secret' => env('ESIGN_SECRET'),
    /**
     * 签名方式 ：支持RSA、 HMACSHA256
     * 使用RSA签名方式，需打开php_openssl扩展。
     */
