...
<html lang="en">
    ...
    <body>
        <div>
            ...
            <div>
                <span>
                    贷款期限：自本协议生效之日起【<?php echo $loan['repay_need'] ?>】个月（下称“分期期数”）。其中宽限期【<?php echo $data['grace_period'] ?>】个月，宽限期内每期仅归还当期利息。
                </span>
            </div>
            <div>
                <span>
            ...
            <div style="line-height:150%; margin:0pt; orphans:0; text-align:justify; widows:0">
                <span>
                    4.5  借款人在贷款发放之日起，可向贷款人申请退课。贷款发放15天（自然日）内为犹豫期，犹豫期内发起退课申请的，由借款人联系学校，并由学校将贷款本金全额退还给贷款人，本贷款合同自动终止；贷款发放第16天（自然日）起，发起退课申请的，由借款人按照教育培训机构的退课流程偿还当前剩余未还本金、利息（退课当日不足一个还款周期的，按照一期计算）、退课手续费（放款后16~30天退课手续费 = 当期月还款金额归还后的剩余未还本金*1%；放款后31天及以上退课手续费 = 当期月还款金额归还后的剩余未还本金*3%）、罚息等相关费用，如退课时有未使用完的学费，由借款人与教育培训机构【<?php echo $loan['school_name'] ?>】协商解决。
                </span>
            </div>
            <div style="line-height:150%; margin:0pt; orphans:0; text-align:justify; widows:0">
                <span>
                    4.6   借款人如果发生15天及以上的逾期时，贷款人有权视同借款人已发起退课申请，贷款人可向教育培训机构【<?php echo $loan['school_name'] ?>】要求对借款人进行停课、扣留相关证照等处理，由借款人偿还当前剩余未还本金、利息（退课当日不足一个还款周期的，按照一期计算）、退课手续费（放款后16~30天退课手续费 =  当期月还款金额归还后的剩余未还本金*1%；放款后31天及以上退课手续费 = 当期月还款金额归还后的剩余未还本金*3%）、罚息等相关费用，如退课时有未使用完的学费，由借款人与教育培训机构【<?php echo $loan['school_name'] ?>】协商解决。
                </span>
            </div>
            <div>
                <span style="font-weight:bold; text-decoration:underline">
