...
class BULoanStatus
{
    ...
    public static function getStatusDescriptionForAdmin($status = null)
    {
        $info = [
            ...
            LOAN_3000_PF_CONFIRM => '大圣已通过',
            LOAN_3100_PF_REFUSE => '大圣已拒绝',
            LOAN_3200_PF_CREDIT_COMPANY => '大圣脚本问题--机构查询',
            LOAN_3300_PF_CREDIT_UPLOAD => '大圣脚本问题--上传文件',
            LOAN_3400_PF_CREDIT_SEND_INFO => '大圣脚本问题--提交信息',
            LOAN_3500_PF_CREDIT_LOAN_APPLY => '大圣脚本问题--贷款申请',
            LOAN_3600_PF_CREDIT_UPLOAD_SUCCESS => '大圣脚本成功--上传文件',
            LOAN_3700_PF_CREDIT_SEND_INFO_SUCCESS => '大圣脚本成功--提交信息',
